...
public class PokemonPersistenceTest {
    ...
    @Inject 
    PokemonPersistence pokePersistence;
    ...
    public  void createPokemonTest() {
        ...
        PokemonEntity result = pokePersistence.create(newEntity);
        ...
        Assert.assertEquals(newEntity.getAltura(), entity.getAltura());
